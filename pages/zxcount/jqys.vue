  ...
  <view :style="{ marginTop: safeHeight }">
    ...
    <table>
      ...
      <tr v-for="(item, index) in tableData.rols" :key="index">
        ...
        <td :class="item.normal1 == '家' || 'red'">{{ item.normal1 }}</td>
        <td :class="item.normal2 == '家' || 'red'">{{ item.normal2 }}</td>
        <td :class="item.normal3 == '家' || 'red'">{{ item.normal3 }}</td>
        <td :class="item.normal4 == '家' || 'red'">{{ item.normal4 }}</td>
        <td :class="item.normal5 == '家' || 'red'">{{ item.normal5 }}</td>
        <td :class="item.normal6 == '家' || 'red'">{{ item.normal6 }}</td>
        <td :class="item.special == '家' || 'red'">{{ item.special }}</td>
      </tr>
    </table>
    <!--底部-->
    <view class="footer">
...
import { animalAnalyze } from "../../utils/zxcount";
