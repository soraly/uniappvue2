<template>
  <view class="mint-tab-container-item" :style="{ marginTop: safeHeight }">
    ...
    <view class="mint-tab-container-item">
      <view class="tab-wrap">
        <view :class="isActive == 0 ? 'active' : ''" @click="tab(0)">热图</view>
        <view :class="isActive == 1 ? 'active' : ''" @click="tab(1)">冷图</view>
      </view>
      <view class="mint-tab-container-item">
...
import { animalStat } from "../../utils/zxcount";
...
export default {
  ...
  data() {
    return {
      ...
      type: 1,
      isActive: 0,
      colorList: ['#c23531', '#2f4554', '#61a0a8', '#c23531', '#61a0a8', '#61a0a8', '#749f83', '#ca8622', '#bda29a', '#6e7074', '#546570', '#c4ccd3'],
      hotData: {},
      coldData: {},
    }
  },
  ...
  methods: {
    ...
    animalStat: function () {
      let prams = { period: this.period, type: this.type }
