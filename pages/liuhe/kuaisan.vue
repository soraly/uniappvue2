<template>
  <view class="kuaisan-board" :style="{ marginTop: safeHeight, height: windowHeight }">
    ...
    <view class="top-header" v-else>
      <nav-bar :nav-bar-height="40" :isBack="false" :left-width="180" :right-width="180" :title="''"
      ...
      <view class="board">
        ...
        <view class="board-content">
          <view class="board-content-item">
            <view class="top">
              <text v-if="this.headInfo.stampType === 3 || this.headInfo.stampType === 1">{{ `第${headInfo.nextShorNo ?
                headInfo.nextShorNo : ''}期` }}</text>
          ...
          <view class="board-content-item-right">
            <view class="info">
              ...
              <view class="line3">
                <text v-if="headInfo.stampType === 1" style="color:#FFFF00">等待开盘中</text>
...
import templateSelector from "@/config/templateMemSelector/KuaisanTemplateSelector.js"
...
export default {
  ...
  data() {
    return {
      ...
      navBg: require('./../../static/img/liuhe/kuaisan/nav.png'),
      ...
      menuList: [
        {
          name: '最近开奖',
          isSwitch: false,
          url: '/pages/liuhe/kuaisan/recent_draws',
  ...
  onLoad(option) {
    ...
    if (option.id) {//判断id进入后，获取数据
      ...
      // console.log(this.inLotteryId, this.lotteryId)
      ...
      uni.$on("onGetGameInfo", function (resultInfo) {
        console.log("onGetGameInfo", resultInfo);
  ...
  methods: {
    ...
    getCartList() {
      ...
      console.log("carts", this.cartList, this.orderList)
    ...
    setOrders(data) {
      ...
      // console.log("ball",ball,this.orderList);
      ...
      if (ball.code === "ksbthethdxth" || ball.code === "ksbthethdxbth" || ball.code === "ksbthethfx") {
        ...
        // ////console.log("datas",data,this.orderList);
    ...
    toBuy(obj) {
      ...
      if (this.userInfo) {
        ...
        if (this.menuList[4].isOpen) {//角标4表示右上角菜单，打开了购物车功能
          let code = '';
          if (this.orderList[0]) {
    ...
    doCommitUpdateEventBySocket() {
      ...
      console.log("发送更新事件", socketInitStruct);
...
.kuaisan-board {
  ...
  .top-header {
    ...
    .board {
      background-image: url("./../../static/img/liuhe/kuaisan/bg.png");
      ...
      .close-ball-list {
        ...
        .close-ball-item {
          background-image: url("./../../static/img/liuhe/kuaisan/close.png");
