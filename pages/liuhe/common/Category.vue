...
export default {
	...
	methods: {
		...
		getGameList() {
			...
			const key = EncryptUtils.encryptMacToBase64(JSON.stringify(prams), CryptoJS.MD5(CryptoJS.enc.Utf8.parse(config.apiKey)))
