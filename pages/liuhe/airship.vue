...
import templateSelector from "@/config/templateMemSelector/AirshipTemplateSelector.js"
...
export default {
  ...
  data() {
    return {
      ...
      navBg: require('./../../static/img/liuhe/airship/header-bg.jpg'),
      ...
      menuList: [
        {
          name: '最近开奖',
          isSwitch: false,
          url: '/pages/liuhe/airship/recent_draws',
  ...
  methods: {
    ...
    setOrders(data) {
      this.isShowOrder = false;
      let { ball, ballChildren, ballItem } = data;
...
.liuhe-board {
  ...
  .top-header {
    ...
    .board {
      background-image: url("./../../static/img/liuhe/airship/bg.jpg");
      ...
      .close-ball-list {
        ...
        .close-ball-item {
          background-image: url("./../../static/img/liuhe/airship/close.png");
