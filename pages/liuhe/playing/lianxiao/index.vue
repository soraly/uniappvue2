...
export default {
  ...
  methods:{
    ...
    onClickItem(item,key){
      //console.log(this.playData.children[key]);
      ...
      this.$forceUpdate()
        this.changeChildren({ballChildren : this.ballList, dataIndex : this.dataIndex, selectedIds:this.currentArr, ball: ball,ballItem:item})
    },
