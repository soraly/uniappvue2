<template>
  <view class="luckyTwenty-board" :style="{ marginTop: safeHeight, height: windowHeight }">
...
import templateSelector from "@/config/templateMemSelector/LuckyTwentyTemplateSelector.js"
...
export default {
  ...
  data() {
    return {
      ...
      navBg: require('./../../static/img/liuhe/lucky/header-bg.png'),
      ...
      menuList: [
        {
          name: '最近开奖',
          isSwitch: false,
          url: '/pages/liuhe/luckyTwenty/recent_draws',
...
.luckyTwenty-board {
  ...
  .top-header {
    ...
    .board {
      background-image: url("./../../static/img/liuhe/lucky/board-bg.png");
